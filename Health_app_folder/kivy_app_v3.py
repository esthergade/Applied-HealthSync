...
class ChildApp(GridLayout):
    def __init__(self, **kwargs):
        ...
        self.cols = 2 #two columns in the app.

        self.add_widget(Label(text='Enter systolic blood pressure (mm Hg)')) #adding a text input for systolic
        self.s_bloodpressure_sys = TextInput() #using the TextInput function earlier imported
        ...
        self.add_widget(Label(text='Enter heart rate')) #doing the same for heart rate
        ...
        self.press = Button(text="Check Health status") #adding a button for plotting the reported data
        self.press.bind(on_press=self.on_text) #we have not defined yet what this button does
        self.add_widget(self.press)
    ...
    def on_text(self, instance, value):
        try:
            ...
            elif 130 < blood_pressure_sys <= 139 or 80 < blood_pressure_dia <= 89:
